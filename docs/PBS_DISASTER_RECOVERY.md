...
│  FAILED STATE:                                                              │
│  ┌─────────────┐                                                            │
│  │   PBS LXC   │  ← Both drives failed                                      │
│  │   node03    │    • 1TB NVMe (daily)                                      │
│  │   LXC 100   │    • 4TB HDD (main)                                        │
│  └─────────────┘                                                            │
│                                                                             │
│  RECOVERY SOURCE:                                                           │
│  ┌─────────────────────┐                                                    │
│  │   Synology NAS      │  ← Offsite backup copy                             │
│  │   192.168.20.31     │    /volume2/ProxmoxData/pbs-offsite/               │
│  │   /pbs-offsite/     │    • main/   (~20GB)                               │
│  │                     │    • daily/  (~38GB)                               │
│  └─────────────────────┘                                                    │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
### Issue: Datastores not visible in PBS
...
### Issue: Proxmox VE can't connect to PBS
...
- [PBS Monitoring](./PBS_MONITORING.md)
