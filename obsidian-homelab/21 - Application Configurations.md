...
```bash
ssh hermes-admin@192.168.40.13 "sudo mkdir -p /opt/life-progress"
```
...
```bash
ssh hermes-admin@192.168.40.13 "sudo docker restart life-progress"
```
...
```bash
ssh hermes-admin@192.168.40.13 "cd /opt/glance && sudo docker compose restart"
```
